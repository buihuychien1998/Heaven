package com.labrace.heaven.adapter;
...
import com.labrace.heaven.R;
import com.labrace.heaven.activity.MainNavActivity;
import com.labrace.heaven.bean.Image;
import com.labrace.heaven.billing.PurchaseManager;
import com.labrace.heaven.common.Constants;
import com.labrace.heaven.service.FTPService;
import com.labrace.heaven.service.TorsoCADService;
import com.labrace.heaven.utils.CommonUtils;
...
public class PatientImagesAdapter extends RecyclerView.Adapter<PatientImagesAdapter.PatientViewHolder> implements View.OnClickListener {
    ...
    public PatientImagesAdapter(Context context, List<Image> images, TextView textEmpty, int mTorsoId,
        ...
        Bitmap bm = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.sunset_beach);
        image.setBitmap(bm);
        Image image1 = new Image();
        Bitmap bm1 = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.sunset_board);
        image1.setBitmap(bm1);
        Image image2 = new Image();
        Bitmap bm2 = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.sunset_lake);
        image2.setBitmap(bm2);
        Image image3 = new Image();
        Bitmap bm3 = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.sunset_westlake);
